package com.wsy.viewspread.helper;
...
import com.wsy.viewspread.view.BaseFramlayout;
import com.wsy.viewspread.view.BaseView;
    ...
    protected void addViewInWindow(final Activity mActivity
        ...
        mActivity.getWindow().getDecorView().post(new Runnable() {
            ...
            public void run() {
                ...
                if(AbstractViewHelper.mStartActivity == null){//如果是跳转Activity  则不处理触摸事件 否则处理
